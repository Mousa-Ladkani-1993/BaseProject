...
var PropertiesDataTable = function () {
    var PropertiesDataTableObj = function () {
        PropertiesDT = $('#PendingPropertiesDiv').KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
    ...
    return {
        init: function () {
            ...
            $("#PendingPropertiesDiv").on("click", ".show-delete-data", function (e) {
                Swal.fire({
                    title: 'Alert',
            ...
            $("#PendingPropertiesDiv").on("click", ".Approve", function (e) {
                Swal.fire({
                    title: 'Alert',
            ...
            $("#PendingPropertiesDiv").on("click", ".Reject", function (e) {
                Swal.fire({
                    title: 'Alert',
