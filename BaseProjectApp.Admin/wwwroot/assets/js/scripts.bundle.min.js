...
////var KTApp = function () {
////    var t = {}, e = function (t) {
////        var e = t.data("skin") ? "tooltip-" + t.data("skin") : "", a = "auto" == t.data("width") ? "tooltop-auto-width" : "", n = t.data("trigger") ? t.data("trigger") : "hover";
...
////                    e = $(t.target).find(".dropdown-menu"), $("body").append(e.detach()), e.css("display", "block"),
////                        e.position({
////                            my: "right top",
////                            at: "right bottom",
////                            of: $(t.relatedTarget)
...
////                KTUtil.get("body").prepend(n), KTUtil.addClass(n, o), n.innerHTML = "<span>" + e.message + "</span><span>" + i + "</span>",
////                    e.width = KTUtil.actualWidth(n) + 10, KTUtil.remove(n), "body" == t && (a = '<div class="' + o + '" style="margin-left:-' + e.width / 2 + 'px;"><span>' + e.message + "</span><span>" + i + "</span></div>");
////            } else a = i;
////            var l = {
////                message: a,
////                centerY: e.centerY,
...
////    for (var t = 0, e = ["webkit", "moz"], a = 0; a < e.length && !window.requestAnimationFrame; ++a) window.requestAnimationFrame = window[e[a] + "RequestAnimationFrame"],
...
////                set: function (e, a) {
////                    void 0 !== t && (void 0 === t.customDataTag && (KTUtilElementDataStoreID++, t.customDataTag = KTUtilElementDataStoreID),
...
////        offset: function (t) {
////            var e, a;
////            if (t = KTUtil.get(t)) return t.getClientRects().length ? (e = t.getBoundingClientRect(),
...
////            var n, i = "";
////            if ((t = KTUtil.get(t)) instanceof HTMLElement != !1) return t.getAttribute("kt-hidden-" + e) && !1 !== a ? parseFloat(t.getAttribute("kt-hidden-" + e)) : (i = t.style.cssText,
////                t.style.cssText = "position: absolute; visibility: hidden; display: block;", "width" == e ? n = t.offsetWidth : "height" == e && (n = t.offsetHeight),
...
////                    return t.runtimeStyle.left = t.currentStyle.left, t.style.left = e || 0, e = t.style.pixelLeft + "px",
////                        t.style.left = a, t.runtimeStyle.left = n, e;
////                }(a) : a;
////            }
////        },
...
////                document.documentElement.scrollTop = t, document.body.parentNode.scrollTop = t,
...
////                    (e.mobileNativeScroll || e.disableForMobile) && KTUtil.isInResponsiveRange("tablet-and-mobile")) (a = KTUtil.data(t).get("ps")) ? (e.resetHeightOnDestroy ? KTUtil.css(t, "height", "auto") : (KTUtil.css(t, "overflow", "auto"),
////                        n > 0 && KTUtil.css(t, "height", n + "px")), a.destroy(), a = KTUtil.data(t).remove("ps")) : n > 0 && (KTUtil.css(t, "overflow", "auto"),
////                            KTUtil.css(t, "height", n + "px")); else if (n > 0 && KTUtil.css(t, "height", n + "px"),
////                                e.desktopNativeScroll) KTUtil.css(t, "overflow", "auto"); else {
////                    KTUtil.css(t, "overflow", "hidden"), (a = KTUtil.data(t).get("ps")) ? a.update() : (KTUtil.addClass(t, "kt-scroll"),
...
////                    o.build(), KTUtil.data(n).set("avatar", a)), a;
////            },
////            init: function (t) {
////                a.element = n, a.events = [], a.input = KTUtil.find(n, 'input[type="file"]'), a.holder = KTUtil.find(n, ".kt-avatar__holder"),
////                    a.cancel = KTUtil.find(n, ".kt-avatar__cancel"), a.src = KTUtil.css(a.holder, "backgroundImage"),
...
////                    t.preventDefault(), KTUtil.removeClass(a.element, "kt-avatar--changed"), KTUtil.css(a.holder, "background-image", a.src),
////                        a.input.value = "";
////                });
////            },
...
////        },
////        show: function () {
////            return o.eventTrigger("show"), e = document.createElement("DIV"), KTUtil.setHTML(e, a.options.message),
////                KTUtil.addClass(e, "kt-dialog kt-dialog--shown"), KTUtil.addClass(e, "kt-dialog--" + a.options.state),
////                KTUtil.addClass(e, "kt-dialog--" + a.options.type), "top center" == a.options.placement && KTUtil.addClass(e, "kt-dialog--top-center"),
////                n.appendChild(e), a.state = "shown", o.eventTrigger("shown"), a;
////        },
////        hide: function () {
////            return e && (o.eventTrigger("hide"), e.remove(), a.state = "hidden", o.eventTrigger("hidden")),
////                a;
////        },
////        eventTrigger: function (t) {
////            for (var e = 0; e < a.events.length; e++) {
...
////                    l.build(), KTUtil.data(n).set("header", a)), a;
////            },
////            init: function (t) {
...
////                    var n, o, r, s = 0;
////                    KTUtil.isInResponsiveRange("desktop") ? (s = a.options.offset.desktop, n = a.options.minimize.desktop.on,
////                        o = a.options.minimize.desktop.off) : KTUtil.isInResponsiveRange("tablet-and-mobile") && (s = a.options.offset.mobile,
////                            n = a.options.minimize.mobile.on, o = a.options.minimize.mobile.off), r = window.pageYOffset,
...
////                            KTUtil.removeClass(i, o), e && (l.eventTrigger("minimizeOn", a), e = !1)) : (KTUtil.addClass(i, o),
////                                KTUtil.removeClass(i, n), 0 == e && (l.eventTrigger("minimizeOff", a), e = !0)) : (r > s && t < r ? (KTUtil.addClass(i, n),
////                                    KTUtil.removeClass(i, o), e && (l.eventTrigger("minimizeOn", a), e = !1)) : (KTUtil.addClass(i, o),
////                                        KTUtil.removeClass(i, n), 0 == e && (l.eventTrigger("minimizeOff", a), e = !0)),
////                                    t = r);
////                });
////            },
...
////                    r.reset(), r.build(), KTUtil.data(i).set("menu", a)), a;
////            },
////            init: function (t) {
////                a.events = [], a.eventHandlers = {}, a.options = KTUtil.deepExtend({}, l, t), a.pauseDropdownHoverTime = 0,
////                    a.uid = KTUtil.getUniqueID();
////            },
////            update: function (t) {
////                a.options = KTUtil.deepExtend({}, l, t), a.pauseDropdownHoverTime = 0, r.reset(),
////                    a.eventHandlers = {}, r.build(), KTUtil.data(i).set("menu", a);
////            },
////            reload: function () {
...
////            },
////            reset: function () {
////                KTUtil.off(i, "click", a.eventHandlers.event_1), KTUtil.off(i, "mouseover", a.eventHandlers.event_2),
////                    KTUtil.off(i, "mouseout", a.eventHandlers.event_3), KTUtil.off(i, "click", a.eventHandlers.event_4),
////                    KTUtil.off(i, "click", a.eventHandlers.event_5), KTUtil.off(i, "click", a.eventHandlers.event_6);
////            },
////            scrollInit: function () {
...
////                    "1" == this.getAttribute("data-hover") && (this.removeAttribute("data-hover"), clearTimeout(this.getAttribute("data-timeout")),
////                        this.removeAttribute("data-timeout")), r.showSubmenuDropdown(this);
////                }
////            },
...
////                            r.hideSubmenuDropdown(e, !0)), t.preventDefault());
////                }
////            },
...
////                        r.showSubmenuDropdown(e)), t.preventDefault());
////                }
////            },
...
////                    t.removeAttribute("data-hover"), t.getAttribute("data-ktmenu-dropdown-toggle-class") && KTUtil.removeClass(o, t.getAttribute("data-ktmenu-dropdown-toggle-class"));
...
////                    }
////                }
////                if (!1 === a.options.accordion.expandAll && (e = i.querySelectorAll(".kt-menu__item--open"))) for (o = 0,
////                    l = e.length; o < l; o++) KTUtil.removeClass(n[0], "kt-menu__item--open");
////            },
...
////                    l.build(), KTUtil.data(n).set("offcanvas", a)), a;
////            },
////            init: function (t) {
////                a.events = [], a.options = KTUtil.deepExtend({}, o, t), a.overlay, a.classBase = a.options.baseClass,
////                    a.classShown = a.classBase + "--on", a.classOverlay = a.classBase + "-overlay",
...
////            },
////            show: function (t) {
////                "shown" != a.state && (l.eventTrigger("beforeShow"), l.togglerClass(t, "show"),
////                    KTUtil.addClass(i, a.classShown), KTUtil.addClass(n, a.classShown), KTUtil.css(n, "opacity", "1"),
////                    a.state = "shown", a.options.overlay && (a.overlay = KTUtil.insertAfter(document.createElement("DIV"), n),
////                        KTUtil.addClass(a.overlay, a.classOverlay), KTUtil.addEvent(a.overlay, "click", function (e) {
////                            e.stopPropagation(), e.preventDefault(), l.hide(t);
////                        })), l.eventTrigger("afterShow"));
////            },
////            hide: function (t) {
////                "hidden" != a.state && (l.eventTrigger("beforeHide"), l.togglerClass(t, "hide"),
////                    KTUtil.removeClass(i, a.classShown), KTUtil.removeClass(n, a.classShown), a.state = "hidden",
////                    a.options.overlay && a.overlay && KTUtil.remove(a.overlay), KTUtil.transitionEnd(n, function () {
...
////                    l.build(), KTUtil.data(n).set("portlet", a)), a;
////            },
////            init: function (t) {
////                a.element = n, a.events = [], a.options = KTUtil.deepExtend({}, o, t), a.head = KTUtil.child(n, ".kt-portlet__head"),
////                    a.foot = KTUtil.child(n, ".kt-portlet__foot"), KTUtil.child(n, ".kt-portlet__body") ? a.body = KTUtil.child(n, ".kt-portlet__body") : KTUtil.child(n, ".kt-form") && (a.body = KTUtil.child(n, ".kt-form"));
////            },
////            build: function () {
...
////                        KTUtil.addClass(i, "kt-portlet--sticky"), KTUtil.addClass(n, "kt-portlet--sticky"),
////                        l.updateSticky()) : 1.5 * o <= e && KTUtil.hasClass(i, "kt-portlet--sticky") && (l.eventTrigger("stickyOff"),
////                            KTUtil.removeClass(i, "kt-portlet--sticky"), KTUtil.removeClass(n, "kt-portlet--sticky"),
////                            l.resetSticky());
////                }
////            },
...
////                    KTUtil.css(a.head, "z-index", a.options.sticky.zIndex), KTUtil.css(a.head, "top", t + "px"),
////                    KTUtil.css(a.head, "left", e + "px"), KTUtil.css(a.head, "right", n + "px")));
////            },
////            resetSticky: function () {
////                a.head && !1 === KTUtil.hasClass(i, "kt-portlet--sticky") && (KTUtil.css(a.head, "z-index", ""),
////                    KTUtil.css(a.head, "top", ""), KTUtil.css(a.head, "left", ""), KTUtil.css(a.head, "right", ""));
////            },
////            remove: function () {
...
////                    l.removeTooltips(), KTUtil.remove(n), l.eventTrigger("afterRemove"));
////            },
...
////                if ("off" === t || KTUtil.hasClass(i, "kt-portlet--fullscreen") && KTUtil.hasClass(n, "kt-portlet--fullscreen")) l.eventTrigger("beforeFullscreenOff"),
////                    KTUtil.removeClass(i, "kt-portlet--fullscreen"), KTUtil.removeClass(n, "kt-portlet--fullscreen"),
////                    l.removeTooltips(), l.setupTooltips(), a.foot && (KTUtil.css(a.body, "margin-bottom", ""),
////                        KTUtil.css(a.foot, "margin-top", "")), l.eventTrigger("afterFullscreenOff"); else {
////                    if (l.eventTrigger("beforeFullscreenOn"), KTUtil.addClass(n, "kt-portlet--fullscreen"),
////                        KTUtil.addClass(i, "kt-portlet--fullscreen"), l.removeTooltips(), l.setupTooltips(),
////                        a.foot) {
...
////                    l.build(), KTUtil.data(n).set("scrolltop", a)), a;
////            },
////            init: function (t) {
////                a.events = [], a.options = KTUtil.deepExtend({}, o, t);
////            },
...
////                    o.build(), KTUtil.data(n).set("toggle", a)), a;
////            },
////            init: function (t) {
////                a.element = n, a.events = [], a.options = KTUtil.deepExtend({}, i, t), a.target = KTUtil.get(a.options.target),
////                    a.targetState = a.options.targetState, a.togglerState = a.options.togglerState,
...
////            },
////            toggle: function (t) {
////                return o.eventTrigger("beforeToggle"), "off" == a.state ? o.toggleOn() : o.toggleOff(),
////                    o.eventTrigger("afterToggle"), t.preventDefault(), a;
////            },
////            toggleOn: function () {
////                return o.eventTrigger("beforeOn"), KTUtil.addClass(a.target, a.targetState), a.togglerState && KTUtil.addClass(n, a.togglerState),
////                    a.state = "on", o.eventTrigger("afterOn"), o.eventTrigger("toggle"), a;
////            },
////            toggleOff: function () {
////                return o.eventTrigger("beforeOff"), KTUtil.removeClass(a.target, a.targetState),
////                    a.togglerState && KTUtil.removeClass(n, a.togglerState), a.state = "off", o.eventTrigger("afterOff"),
////                    o.eventTrigger("toggle"), a;
////            },
////            eventTrigger: function (t) {
////                for (var e = 0; e < a.events.length; e++) {
////                    var n = a.events[e];
...
////                    o.build(), KTUtil.data(n).set("wizard", a)), a;
////            },
////            init: function (t) {
////                a.element = n, a.events = [], a.options = KTUtil.deepExtend({}, i, t), a.steps = KTUtil.findAll(n, '[data-ktwizard-type="step"]'),
////                    a.btnSubmit = KTUtil.find(n, '[data-ktwizard-type="action-submit"]'), a.btnNext = KTUtil.find(n, '[data-ktwizard-type="action-next"]'),
////                    a.btnPrev = KTUtil.find(n, '[data-ktwizard-type="action-prev"]'), a.btnLast = KTUtil.find(n, '[data-ktwizard-type="action-last"]'),
////                    a.btnFirst = KTUtil.find(n, '[data-ktwizard-type="action-first"]'), a.events = [],
////                    a.currentStep = 1, a.stopped = !1, a.totalSteps = a.steps.length, a.options.startStep > 1 && o.goTo(a.options.startStep),
////                    o.updateUI();
////            },
////            build: function () {
...
////                        !0 !== a.stopped) return !1 !== e && (o.eventTrigger("beforeChange"), a.currentStep = t,
////                            o.updateUI(), o.eventTrigger("change")), t > a.startStep ? o.eventTrigger("afterNext") : o.eventTrigger("afterPrev"),
////                            a;
////                    a.stopped = !1;
////                }
////            },
...
////                init: function (e) {
////                    var a, n = !1;
////                    null === e.data.source && (l.extractTable(), n = !0), l.setupBaseDOM.call(), l.setupDOM(o.table),
////                        l.setDataSourceQuery(l.getOption("data.source.read.params.query")), t(o).on("kt-datatable--on-layout-updated", l.afterRender),
////                        o.debug && l.stateRemove(l.stateId), t.each(l.getOption("extensions"), function (e, a) {
////                            "function" == typeof t.fn.KTDatatable[e] && new t.fn.KTDatatable[e](o, a);
////                        }), l.spinnerCallback(!0), "remote" !== e.data.type && "local" !== e.data.type || ((!1 === e.data.saveState || !1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage) && l.stateRemove(l.stateId),
////                            "local" === e.data.type && "object" == typeof e.data.source && (o.dataSet = o.originalDataSet = l.dataMapCallback(e.data.source)),
////                            l.dataRender()), n && (t(o.tableHead).find("tr").remove(), t(o.tableFoot).find("tr").remove()),
////                        l.setHeadTitle(), l.getOption("layout.footer") && l.setHeadTitle(o.tableFoot), void 0 !== e.layout.header && !1 === e.layout.header && t(o.table).find("thead").remove(),
////                        void 0 !== e.layout.footer && !1 === e.layout.footer && t(o.table).find("tfoot").remove(),
////                        null !== e.data.type && "local" !== e.data.type || (l.setupCellField.call(), l.setupTemplateCell.call(),
////                            l.setupSubDatatable.call(), l.setupSystemColumn.call(), l.redraw());
////                    var i = !1;
////                    return t(window).resize(function () {
////                        i || (a = t(this).width(), i = !0), t(this).width() !== a && (a = t(this).width(),
////                            l.fullRender());
...
////                    l.setupSubDatatable.call(), l.setupSystemColumn.call(), l.setupHover.call(), void 0 === i.detail && 1 === l.getDepth() && l.lockTable.call(),
////                        l.resetScroll(), l.isLocked() || (l.redraw.call(), l.isSubtable() || !0 !== l.getOption("rows.autoHide") || l.autoHide(),
////                            t(o.table).find(".kt-datatable__row").css("height", "")), l.columnHide.call(), l.rowEvenOdd.call(),
////                        l.sorting.call(), l.scrollbar.call(), l.isInit || (l.dropdownFix(), t(o).trigger("kt-datatable--on-init", {
...
////                        e = t(a.target).find(".dropdown-menu"), t("body").append(e.detach()), e.css("display", "block"),
////                            e.position({
////                                my: "right top",
////                                at: "right bottom",
...
////                                            var n = t("<div/>").addClass("kt-datatable__lock kt-datatable__lock--left"), i = t("<div/>").addClass("kt-datatable__lock kt-datatable__lock--scroll"), r = t("<div/>").addClass("kt-datatable__lock kt-datatable__lock--right");
////                                            t(a).find(".kt-datatable__row").each(function () {
////                                                var e = t("<tr/>").addClass("kt-datatable__row").data("obj", t(this).data("obj")).appendTo(n), a = t("<tr/>").addClass("kt-datatable__row").data("obj", t(this).data("obj")).appendTo(i), o = t("<tr/>").addClass("kt-datatable__row").data("obj", t(this).data("obj")).appendTo(r);
...
////                                                t(n).appendTo(a)), (e.lockEnabled.left.length > 0 || e.lockEnabled.right.length > 0) && t(i).appendTo(a),
////                                                e.lockEnabled.right.length > 0 && (t(o.wrap).addClass("kt-datatable--lock"), t(r).appendTo(a));
...
////                },
////                fullRender: function () {
////                    t(o.tableHead).empty(), l.setHeadTitle(), l.getOption("layout.footer") && (t(o.tableFoot).empty(),
////                        l.setHeadTitle(o.tableFoot)), l.spinnerCallback(!0), t(o.wrap).removeClass("kt-datatable--loaded"),
////                        l.insertData();
////                },
////                lockEnabledColumns: function () {
////                    var e = t(window).width(), n = i.columns, o = {
////                        left: [],
////                        right: []
////                    };
...
////                    t(o).ready(function () {
////                        l.isLocked() && l.redraw(), t(o.tableBody).css("visibility", ""), t(o.wrap).addClass("kt-datatable--loaded"),
////                            l.spinnerCallback(!1);
////                    });
////                },
////                hoverTimer: 0,
...
////                            l.isScrolling = !1;
////                        }, 200), !l.isScrolling) {
////                            var e = t(this).closest(".kt-datatable__row").addClass("kt-datatable__row--hover"), a = t(e).index() + 1;
////                            t(e).closest(".kt-datatable__lock").parent().find(".kt-datatable__row:nth-child(" + a + ")").addClass("kt-datatable__row--hover");
////                        }
////                    }).on("mouseleave", function () {
////                        var e = t(this).closest(".kt-datatable__row").removeClass("kt-datatable__row--hover"), a = t(e).index() + 1;
...
////                    var e = t(o.tableHead).width(), a = t(o.tableHead).find(".kt-datatable__lock--left").width(), n = t(o.tableHead).find(".kt-datatable__lock--right").width();
...
////                        var e = t(o.tableHead).find(".kt-datatable__row").outerHeight(), a = t(o.tableFoot).find(".kt-datatable__row").outerHeight(), n = i.layout.height;
////                        e > 0 && (n -= e), a > 0 && (n -= a), n -= 2, t(o.tableBody).css("max-height", n),
////                            t(o.tableBody).find(".kt-datatable__lock--scroll").css("height", n);
////                    }
////                },
////                setupBaseDOM: function () {
////                    o.initialDatatable = t(o).clone(), "TABLE" === t(o).prop("tagName") ? (o.table = t(o).removeClass("kt-datatable").addClass("kt-datatable__table"),
...
////                                o.table = t("<table/>").addClass("kt-datatable__table").appendTo(o)), void 0 !== i.layout.class && t(o.wrap).addClass(i.layout.class),
////                        t(o.table).removeClass("kt-datatable--destroyed").css("display", "block"), void 0 === t(o).attr("id") && (l.setOption("data.saveState", !1),
////                            t(o.table).attr("id", a.getUniqueID("kt-datatable--"))), l.getOption("layout.minHeight") && t(o.table).css("min-height", l.getOption("layout.minHeight")),
////                        l.getOption("layout.height") && t(o.table).css("max-height", l.getOption("layout.height")),
////                        null === i.data.type && t(o.table).css("width", "").css("display", ""), o.tableHead = t(o.table).find("thead"),
////                        0 === t(o.tableHead).length && (o.tableHead = t("<thead/>").prependTo(o.table)),
////                        o.tableBody = t(o.table).find("tbody"), 0 === t(o.tableBody).length && (o.tableBody = t("<tbody/>").appendTo(o.table)),
...
////                                    var d = "";
////                                    "string" == typeof s.template && (d = l.dataPlaceholder(s.template, i)), "function" == typeof s.template && (d = s.template(i, e, o)),
////                                        "undefined" != typeof DOMPurify && (d = DOMPurify.sanitize(d));
////                                    var c = document.createElement("span");
////                                    c.innerHTML = d, t(r).html(c), void 0 !== s.overflow && (t(c).css("overflow", s.overflow),
...
////                    var e = t(o.tableBody).innerWidth() - l.iconOffset, a = t(o.tableBody).find(".kt-datatable__row:first-child").find(".kt-datatable__cell").not(".kt-datatable__toggle-detail").not(":hidden").length;
////                    if (a > 0) {
////                        e -= l.iconOffset * a;
...
////                },
////                setupDOM: function (e) {
////                    t(e).find("> thead").addClass("kt-datatable__head"), t(e).find("> tbody").addClass("kt-datatable__body"),
////                        t(e).find("> tfoot").addClass("kt-datatable__foot"), t(e).find("tr").addClass("kt-datatable__row"),
////                        t(e).find("tr > th, tr > td").addClass("kt-datatable__cell"), t(e).find("tr > th, tr > td").each(function (e, a) {
...
////                                        e.scrollFoot = t(o.tableFoot).find("> .kt-datatable__row"), l.getOption("layout.customScrollbar") && 10 != a.detectIE() && n > a.getBreakpoint("lg") ? e.initCustomScrollbar(o.tableBody) : e.initDefaultScrollbar(o.tableBody));
////                            }
////                        },
////                        initDefaultScrollbar: function (a) {
////                            e.initPosition = t(a).scrollLeft(), t(a).css("overflow-y", "auto").off().on("scroll", e.onScrolling),
////                                !0 !== l.getOption("rows.autoHide") && t(a).css("overflow-x", "auto");
////                        },
////                        onScrolling: function (n) {
////                            var i = t(this).scrollLeft(), o = t(this).scrollTop();
////                            a.isRTL() && (i -= e.initPosition), t(e.scrollHead).css("left", -i), t(e.scrollFoot).css("left", -i),
...
////                        var i = s[e];
////                        if (void 0 === i && (i = document.createElement("th"), r.appendChild(i)), void 0 !== n.title && (i.innerHTML = n.title,
////                            i.setAttribute("data-field", n.field), a.addClass(i, n.class), void 0 !== n.autoHide && (!0 !== n.autoHide ? i.setAttribute("data-autohide-disabled", n.autoHide) : i.setAttribute("data-autohide-enabled", n.autoHide)),
////                            t(i).data(n)), void 0 !== n.attr && t.each(n.attr, function (t, e) {
////                                i.setAttribute(t, e);
////                            }), void 0 !== n.textAlign) {
...
////                insertData: function () {
////                    o.dataSet = o.dataSet || [];
////                    var e = l.getDataSourceParam(), n = e.pagination, r = (Math.max(n.page, 1) - 1) * n.perpage, s = Math.min(n.page, n.pages) * n.perpage, d = {};
...
////                            a.addClass(v, g.join(" ")), v.setAttribute("data-field", f.field), void 0 !== f.autoHide && (!0 !== f.autoHide ? v.setAttribute("data-autohide-disabled", f.autoHide) : v.setAttribute("data-autohide-enabled", f.autoHide)),
////                                v.innerHTML = l.getObject(f.field, r), s.appendChild(v);
////                        }
////                        c.appendChild(s);
////                    }), 0 === o.dataSet.length) {
////                        var p = document.createElement("span");
////                        a.addClass(p, "kt-datatable--error"), p.innerHTML = l.getOption("translate.records.noRecords"),
////                            c.appendChild(p), t(o.wrap).addClass("kt-datatable--error kt-datatable--loaded"),
////                            l.spinnerCallback(!1);
////                    }
////                    t(o.tableBody).replaceWith(c), o.tableBody = c, l.setupDOM(o.table), l.setupCellField([o.tableBody]),
////                        l.setupTemplateCell(o.tableBody), l.layoutUpdate();
////                },
////                updateTableComponents: function () {
////                    o.tableHead = t(o.table).children("thead"), o.tableBody = t(o.table).children("tbody"),
...
////                        l.getOption("data.serverPaging") || delete a.pagination, l.getOption("data.serverSorting") || delete a.sort,
////                            e.data = t.extend({}, e.data, l.getOption("data.source.read.params"), a), "string" != typeof (e = t.extend({}, e, l.getOption("data.source.read"))).url && (e.url = l.getOption("data.source.read")),
////                            "string" != typeof e.url && (e.url = l.getOption("data.source"));
////                    }
////                    return t.ajax(e).done(function (e, a, n) {
////                        o.lastResponse = e, o.dataSet = o.originalDataSet = l.dataMapCallback(e), l.setAutoColumns(),
////                            t(o).trigger("kt-datatable--on-ajax-done", [o.dataSet]);
////                    }).fail(function (e, a, n) {
////                        t(o).trigger("kt-datatable--on-ajax-fail", [e]), t(o.tableBody).html(t("<span/>").addClass("kt-datatable--error").html(l.getOption("translate.records.noRecords"))),
////                            t(o.wrap).addClass("kt-datatable--error kt-datatable--loaded"), l.spinnerCallback(!1);
////                    }).always(function () { });
////                },
////                paging: function (e, n) {
////                    var i = {
...
////                        callback: null,
////                        init: function (e) {
////                            i.meta = e, i.meta.page = parseInt(i.meta.page), i.meta.pages = parseInt(i.meta.pages),
////                                i.meta.perpage = parseInt(i.meta.perpage), i.meta.total = parseInt(i.meta.total),
////                                i.meta.pages = Math.max(Math.ceil(i.meta.total / i.meta.perpage), 1), i.meta.page > i.meta.pages && (i.meta.page = i.meta.pages),
////                                i.paginateEvent = l.getTablePrefix("paging"), i.pager = t(o.table).siblings(".kt-datatable__pager"),
////                                t(i.pager).hasClass("kt-datatable--paging-loaded") || (t(i.pager).remove(), 0 !== i.meta.pages && (l.setDataSourceParam("pagination", {
////                                    page: i.meta.page,
////                                    pages: i.meta.pages,
////                                    perpage: i.meta.perpage,
////                                    total: i.meta.total
////                                }), i.callback = i.serverCallback, "function" == typeof n && (i.callback = n), i.addPaginateEvent(),
////                                    i.populate(), i.meta.page = Math.max(i.meta.page || 1, i.meta.page), t(o).trigger(i.paginateEvent, i.meta),
////                                    i.pagingBreakpoint.call(), t(window).resize(i.pagingBreakpoint)));
////                        },
////                        serverCallback: function (t, e) {
////                            l.dataRender();
////                        },
////                        populate: function () {
////                            var e = l.getOption("layout.icons.pagination"), a = l.getOption("translate.toolbar.pagination.items.default");
////                            i.pager = t("<div/>").addClass("kt-datatable__pager kt-datatable--paging-loaded");
////                            var n = t("<ul/>").addClass("kt-datatable__pager-nav");
////                            i.pagerLayout.pagination = n, t("<li/>").append(t("<a/>").attr("title", a.first).addClass("kt-datatable__pager-link kt-datatable__pager-link--first").append(t("<i/>").addClass(e.first)).on("click", i.gotoMorePage).attr("data-page", 1)).appendTo(n),
...
////                                })).appendTo(n);
////                            var r = l.getOption("toolbar.items.pagination.pages.desktop.pagesNumber"), s = Math.ceil(i.meta.page / r) * r, d = s - r;
...
////                                });
////                            var p = t("<select/>").addClass("selectpicker kt-datatable__pager-size").attr("title", l.getOption("translate.toolbar.pagination.items.default.select")).attr("data-width", "60px").val(i.meta.perpage).on("change", i.updatePerpage).prependTo(i.pagerLayout.info), f = l.getOption("toolbar.items.pagination.pageSizeSelect");
...
////                            return void 0 === a && (a = t(e.target).attr("data-page")), i.openPage(parseInt(a)),
////                                !1;
////                        },
////                        gotoPage: function (e) {
...
////                        },
////                        openPage: function (e) {
////                            i.meta.page = parseInt(e), t(o).trigger(i.paginateEvent, i.meta), i.callback(i, i.meta),
////                                t(i.pager).trigger("kt-datatable--on-goto-page", i.meta);
////                        },
////                        updatePerpage: function (e) {
////                            e.preventDefault(), i.pager = t(o.table).siblings(".kt-datatable__pager").removeClass("kt-datatable--paging-loaded"),
////                                e.originalEvent && (i.meta.perpage = parseInt(t(this).val())), t(i.pager).find("select.kt-datatable__pager-size").val(i.meta.perpage).attr("data-selected", i.meta.perpage),
////                                l.setDataSourceParam("pagination", {
////                                    page: i.meta.page,
////                                    pages: i.meta.pages,
////                                    perpage: i.meta.perpage,
////                                    total: i.meta.total
////                                }), t(i.pager).trigger("kt-datatable--on-update-perpage", i.meta), t(o).trigger(i.paginateEvent, i.meta),
////                                i.callback(i, i.meta), i.updateInfo.call();
////                        },
...
////                                    }), t(i.pager).find(".kt-datatable__pager-nav").show(), a.pages <= 1 && t(i.pager).find(".kt-datatable__pager-nav").hide(),
////                                    l.setDataSourceParam("pagination", {
////                                        page: i.meta.page,
////                                        pages: i.meta.pages,
////                                        perpage: i.meta.perpage,
...
////                                    t(o.table).find('.kt-checkbox > [type="checkbox"]').prop("checked", !1), t(o.table).find(".kt-datatable__row--active").removeClass("kt-datatable__row--active"),
////                                    i.updateInfo.call(), i.pagingBreakpoint.call();
////                            });
////                        },
////                        updateInfo: function () {
////                            var e = Math.max(i.meta.perpage * (i.meta.page - 1) + 1, 1), a = Math.min(e + i.meta.perpage - 1, i.meta.total);
...
////                                            case "mobile":
////                                                t(r).show(), t(e).find(".kt-datatable__pager-link--more-prev").closest("li").hide(),
////                                                    t(e).find(".kt-datatable__pager-link--more-next").closest("li").hide(), t(e).find(".kt-datatable__pager-link-number").closest("li").hide();
////                                        }
////                                        return !1;
////                                    }
////                                });
...
////                            var e = t(o.table).siblings(".kt-datatable__pager").find(".kt-datatable__pager-nav"), a = t(e).find(".kt-datatable__pager-link--more-prev"), n = t(e).find(".kt-datatable__pager-link--more-next"), r = t(e).find(".kt-datatable__pager-link--first"), s = t(e).find(".kt-datatable__pager-link--prev"), d = t(e).find(".kt-datatable__pager-link--next"), c = t(e).find(".kt-datatable__pager-link--last"), u = t(e).find(".kt-datatable__pager-link-number"), p = Math.max(t(u).first().data("page") - 1, 1);
...
////                            g.first || t(r).remove(), g.prev || t(s).remove(), g.next || t(d).remove(), g.last || t(c).remove(),
...
////                                t(n).after(r), t(n).hasClass("kt-datatable__row--even") && t(r).addClass("kt-datatable__row-subtable--even")),
////                                t(r).toggle();
////                            var s = t(r).find(".kt-datatable__subtable"), d = t(this).closest("[data-field]:first-child").find(".kt-datatable__toggle-subtable").data("value"), c = t(this).find("i").removeAttr("class");
////                            t(n).hasClass("kt-datatable__row--subtable-expanded") ? (t(c).addClass(l.getOption("layout.icons.rowDetail.collapse")),
////                                t(n).removeClass("kt-datatable__row--subtable-expanded"), t(o).trigger("kt-datatable--on-collapse-subtable", [n])) : (t(c).addClass(l.getOption("layout.icons.rowDetail.expand")),
////                                    t(n).addClass("kt-datatable__row--subtable-expanded"), t(o).trigger("kt-datatable--on-expand-subtable", [n])),
...
////                        l.isSpinning = !0, void 0 !== n && n.block(e, a)) : (l.isSpinning = !1, void 0 !== n && n.unblock(e)));
////                },
...
////                                    n = parseFloat(n), r = parseFloat(r), "asc" === a ? n > r ? 1 : n < r ? -1 : 0 : n < r ? 1 : n > r ? -1 : 0;
...
////                            var r = t("<td/>").addClass("kt-datatable__detail").attr("colspan", l.getTotalColumns()).appendTo(n), s = t("<table/>");
////                            t(o).each(function () {
...
////                            title: e
////                        });
////                    }), t(o.tableHead).find(".kt-datatable__row").remove(), l.setHeadTitle(), l.getOption("layout.footer") && (t(o.tableFoot).find(".kt-datatable__row").remove(),
...
////                    t = l.getTablePrefix(t), !1 !== l.getOption("data.saveState") && (l.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(t, JSON.stringify(e)),
...
////                    var i = t(e).index(), l = t(o.tableBody).find(".kt-datatable__row"), r = t(e).closest(".kt-datatable__lock").index();
...
////                                    var n = t(o.tableHead).find('.kt-datatable__cell[data-field="' + e.field + '"]').attr("data-sort", e.sort), i = t(n).find("span"), r = t(i).find("i"), s = l.getOption("layout.icons.sort");
...
////                                a.addClass(this, "kt-datatable__cell--sorted"), t(o.tableHead).find(".kt-datatable__cell > span > i").remove(),
////                                i.sortable)) {
////                                l.spinnerCallback(!0);
////                                var c = "desc";
...
////                        void 0 !== s && "" !== s && (s = s.toLowerCase(), o.dataSet = t.grep(o.dataSet, r),
////                            delete e.query[l.getGeneralSearchKey()]), t.each(e.query, function (t, a) {
////                                "" === a && delete e.query[t];
...
////                        t(o.table).find(".kt-datatable__lock").css("top", 0), t(o.tableBody).scrollTop(0));
////                },
...
////                        l.push(t);
////                    }), i.width = t(e).width(), i.outerWidth = t(e).outerWidth(a), i.innerWidth = t(e).innerWidth(),
////                        i.height = t(e).height(), i.innerHeight = t(e).innerHeight(), i.outerHeight = t(e).outerHeight(a),
////                        o.each(function (t) {
////                            var e = l[t];
...
////                timer: 0,
////                redraw: function () {
////                    return l.adjustCellsWidth.call(), l.isLocked() && (l.scrollbar(), l.resetScroll(),
////                        l.adjustCellsHeight.call()), l.adjustLockContainer.call(), l.initHeight.call(),
////                        o;
////                },
////                load: function () {
////                    return l.reload(), o;
...
////                    return l.setSelectedRecords(), o.API.value = t(o.API.record).find('[data-field="' + e + '"]'),
////                        o;
////                },
////                destroy: function () {
////                    t(o).parent().find(".kt-datatable__pager").remove();
////                    var e = t(o.initialDatatable).addClass("kt-datatable--destroyed").show();
////                    return t(o).replaceWith(e), t(o = e).trigger("kt-datatable--on-destroy"), l.isInit = !1,
////                        e = null;
////                },
////                sort: function (e, a) {
...
////                    return l.setSelectedRecords(), o.API.record = o.rows(".kt-datatable__row--active").nodes(),
////                        o.API.record;
////                },
...
////                        query: {}
////                    }, o.API.params, l.stateGet(l.stateId)), o.API.params = l.extendObj(o.API.params, e, a),
...
////                            }
////                        }
////                        e ? (l.recentNode === l.nodeCols && delete i.columns[n].visible, t(l.recentNode).show()) : (l.recentNode === l.nodeCols && l.setOption("columns." + n + ".visible", !1),
////                            t(l.recentNode).hide()), l.columnHide(), l.redraw();
////                    }
////                },
////                nodes: function () {
////                    return l.recentNode;
...
////            } else o.data(e) || t(this).hasClass("kt-datatable--loaded") || (o.dataSet = null,
////                o.textAlign = {
////                    left: "kt-datatable__cell--left",
////                    center: "kt-datatable__cell--center",
////                    right: "kt-datatable__cell--right"
////                }, i = t.extend(!0, {}, t.fn.KTDatatable.defaults, i), o.options = i, l.init.apply(this, [i]),
////                t(o.wrap).data(e, o)); else void 0 === (o = t(this).data(e)) && t.error("KTDatatable not initialized"),
////                    i = o.options;
////            return o;
////        }
...
////            unselectedRows: [],
////            init: function () {
////                n.selectorEnabled() && (e.setDataSourceParam(a.vars.selectedAllRows, !1), e.stateRemove("checkbox"),
////                    a.vars.requestIds && e.setDataSourceParam(a.vars.requestIds, !0), t(e).on("kt-datatable--on-reloaded", function () {
////                        e.stateRemove("checkbox"), e.setDataSourceParam(a.vars.selectedAllRows, !1), n.selectedAllRows = !1,
...
////                        });
////                        var o = {};
////                        o.selectedRows = t.unique(n.selectedRows), o.unselectedRows = t.unique(n.unselectedRows),
...
////                    if (n.selectedRows = n.unselectedRows = [], e.stateRemove("checkbox"), t(this).is(":checked") ? n.selectedAllRows = !0 : n.selectedAllRows = !1,
////                        !a.vars.requestIds) {
...
////                    var o = t(this).val();
////                    t(this).is(":checked") ? (n.selectedRows.push(o), n.unselectedRows = n.remove(n.unselectedRows, o)) : (n.unselectedRows.push(o),
////                        n.selectedRows = n.remove(n.selectedRows, o)), !a.vars.requestIds && n.selectedRows.length < 1 && t(e.tableHead).find('.kt-checkbox--all > [type="checkbox"]').prop("checked", !1);
////                    var l = {};
////                    l.selectedRows = t.unique(n.selectedRows), l.unselectedRows = t.unique(n.unselectedRows),
////                        e.stateKeep("checkbox", l), t(e).trigger("kt-datatable--on-click-checkbox", [t(this)]);
////                });
////            },
////            initSelect: function () {
...
////                    e.setActiveAll(!0), n.unselectedRows.forEach(function (t) {
////                        e.setInactive(t);
...
////                    var n = KTUtil.find(t, ".kt-chat"), i = KTUtil.find(t, ".kt-portlet > .kt-portlet__head"), o = KTUtil.find(t, ".kt-portlet > .kt-portlet__body"), l = KTUtil.find(t, ".kt-portlet > .kt-portlet__foot");
...
////            });
////            var a = function () {
////                var e = KTUtil.find(t, ".kt-scroll"), a = KTUtil.find(t, ".kt-chat__messages"), n = KTUtil.find(t, ".kt-chat__input textarea");
////                if (0 !== n.value.length) {
...
////                    KTUtil.setHTML(i, l), a.appendChild(i), n.value = "", e.scrollTop = parseInt(KTUtil.css(a, "height")),
////                        (o = KTUtil.data(e).get("ps")) && o.update(), setTimeout(function () {
...
////                                a.appendChild(t), n.value = "", e.scrollTop = parseInt(KTUtil.css(a, "height")),
...
////                        return a && (t -= parseInt(KTUtil.actualHeight(a)), t -= parseInt(KTUtil.css(a, "marginBottom"))),
////                            t -= parseInt(KTUtil.css(e, "paddingTop")), t -= parseInt(KTUtil.css(e, "paddingBottom"));
////                    }
...
////    var t = KTUtil.get("kt_offcanvas_toolbar_notifications"), e = KTUtil.get("kt_offcanvas_toolbar_quick_actions"), a = KTUtil.get("kt_offcanvas_toolbar_profile"), n = KTUtil.get("kt_offcanvas_toolbar_search");
////    return {
////        init: function () {
////            !function () {
...
////                        return e && (a -= parseInt(KTUtil.actualHeight(e)), a -= parseInt(KTUtil.css(e, "marginBottom"))),
////                            a -= parseInt(KTUtil.css(t, "paddingTop")), a -= parseInt(KTUtil.css(t, "paddingBottom"));
////                    }
////                });
////            }(), function () {
...
////                    height: function () {
////                        var a = parseInt(KTUtil.getViewPort().height);
////                        return t && (a -= parseInt(KTUtil.actualHeight(t)), a -= parseInt(KTUtil.css(t, "marginBottom"))),
////                            a -= parseInt(KTUtil.css(e, "paddingTop")), a -= parseInt(KTUtil.css(e, "paddingBottom"));
////                    }
////                });
////            }(), function () {
...
////                            e -= parseInt(KTUtil.css(a, "paddingTop")), e -= parseInt(KTUtil.css(a, "paddingBottom"));
////                    }
////                });
////            }(), function () {
...
////                        var e = parseInt(KTUtil.getViewPort().height);
////                        return t && (e -= parseInt(KTUtil.actualHeight(t)), e -= parseInt(KTUtil.css(t, "marginBottom"))),
////                            e -= parseInt(KTUtil.css(n, "paddingTop")), e -= parseInt(KTUtil.css(n, "paddingBottom"));
////                    }
////                });
////            }();
////        }
...
////    var t = KTUtil.get("kt_quick_panel"), e = KTUtil.get("kt_quick_panel_tab_notifications"), a = KTUtil.get("kt_quick_panel_tab_logs"), n = KTUtil.get("kt_quick_panel_tab_settings"), i = function () {
...
////        s = a.value, KTUtil.removeClass(t, f), u = !0, KTUtil.addClass(r, p), n && KTUtil.hide(n),
////            setTimeout(function () {
////                $.ajax({
...
////                    },
////                    error: function (e) {
////                        d = !1, g(), KTUtil.addClass(t, f), KTUtil.setHTML(i, '<span class="kt-quick-search__message">Connection error. Pleae try again later.</div>'),
////                            h(), KTUtil.scrollUpdate(i);
////                    }
////                });
////            }, 1e3);
////    }, b = function (e) {
...
////    return {
////        init: function (s) {
////            t = s, e = KTUtil.find(t, ".kt-quick-search__form"), a = KTUtil.find(t, ".kt-quick-search__input"),
////                n = KTUtil.find(t, ".kt-quick-search__close"), i = KTUtil.find(t, ".kt-quick-search__wrapper"),
////                o = KTUtil.find(t, ".dropdown-menu"), l = KTUtil.find(t, '[data-toggle="dropdown"]'),
////                r = KTUtil.find(t, ".input-group"), KTUtil.addEvent(a, "keyup", k), KTUtil.addEvent(a, "focus", k),
...
////    return {
////        init: function () {
////            t = KTUtil.get("body"), this.initHeader(), this.initAside(), this.initAsideSecondary(),
////                this.initPageStickyPortlet(), $("#kt_aside_menu, #kt_header_menu").on("click", '.kt-menu__link[href="#"]', function (t) {
...
////                new KTHeader("kt_header", i), a = new KTOffcanvas("kt_header_menu_wrapper", {
////                    overlay: !0,
...
////        initAside: function () {
////            var a, l, s, d, c, u, p;
////            s = KTUtil.get("kt_aside"), KTUtil.get("kt_aside_brand"), d = KTUtil.hasClass(s, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside",
...
////                    e.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (l && (clearTimeout(l),
////                        l = null), a = setTimeout(function () {
...
////                    e.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (a && (clearTimeout(a),
...
////                                KTUtil.addClass(t, "kt-aside--minimize"), KTUtil.addClass(t, "kt-aside--minimizing"),
////                                KTUtil.transitionEnd(t, function () {
////                                    KTUtil.removeClass(t, "kt-aside--minimizing");
////                                }), n.scrollUpdate(), n.scrollTop());
////                        }, 100));
////                })), u = KTUtil.get("kt_aside_menu"), p = "1" === KTUtil.attr(u, "data-ktmenu-dropdown") ? "dropdown" : "accordion",
////                "1" === KTUtil.attr(u, "data-ktmenu-scroll") && (c = {
////                    rememberPosition: !0,
////                    height: function () {
////                        var t;
...
////                    KTUtil.addClass(t, "kt-aside--minimizing"), KTUtil.get("kt_page_portlet") && r.updateSticky(),
////                        KTUtil.transitionEnd(t, function () {
////                            KTUtil.removeClass(t, "kt-aside--minimizing");
...
////            return t = KTUtil.getViewPort().height, KTUtil.getByID("kt_header") && (t -= KTUtil.actualHeight("kt_header")),
////                KTUtil.getByID("kt_subheader") && (t -= KTUtil.actualHeight("kt_subheader")), KTUtil.getByID("kt_footer") && (t -= parseInt(KTUtil.css("kt_footer", "height"))),
