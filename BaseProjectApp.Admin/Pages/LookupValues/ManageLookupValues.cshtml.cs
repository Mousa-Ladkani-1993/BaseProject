...
{
    [Permission(RolesNames.LOOKUPS, ApiActions.VIEW, PageType.ALL, "LookupValues/ManageLookupValues")]
    public class ManageLookupValuesModel : PageModel
    {
        ...
        public ManageLookupValuesModel(IConfiguration configuration, UserManager<IdentityUser> userManager, IUnitofWork repositories)
        {
        ...
        public async Task<IActionResult> OnGet()
        {
            try
            {
               _permObj = new Perm(RolesNames.LOOKUPS, _repositories, this.User.FindFirst(x => x.Value != null).Value);
                ...
                ViewData["Lookups"] = new SelectList(await _repositories.Lookups.GetAll(), "Id", "Name");
            }
            catch (Exception ex) { 
            }
